              ...
              <div>
                <div className="relative">
                  <input
                    ...
                    type="email"
                    placeholder="Email"
                    className={ `w-full rounded-md py-3 px-4 focus:outline-none focus:ring-1 transition duration-300 ${errors.email ? "border-2 error-animation" : ""
                      }` }
                    style={ {
              ...
              <div>
                <div className="relative">
                  <input
                    ...
                    className={ `w-full rounded-md py-3 px-4 focus:outline-none focus:ring-1 transition duration-300 ${errors.password ? "border-2 error-animation" : ""
                      }` }
                    style={ {
                      backgroundColor: theme.cardBg,
                      color: theme.text,
