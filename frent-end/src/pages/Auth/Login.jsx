...
import { FiMail, FiLock, FiEye, FiEyeOff, FiArrowRight, FiBook, FiTrendingUp } from "react-icons/fi";
  ...
  return (
    <div className="min-h-screen flex bg-[#262338]">
      ...
      <div className="hidden md:flex md:flex-col md:w-1/2 bg-indigo-800 bg-gradient-to-b from-indigo-700 to-indigo-900 text-white p-10 relative overflow-hidden">
        <div className="flex flex-col h-full justify-between z-10 relative">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-2xl font-bold tracking-wider">EduLearn</h1>
            </div>
            <Link 
              to="/"
          ...
          <div>
            ...
            <p className="text-indigo-200 mb-6 max-w-md">
              Access thousands of courses, interactive lessons, and expert instructors to enhance your skills and advance your career.
            </p>
        ...
        <div className="absolute inset-0 bg-center bg-cover bg-no-repeat opacity-30" 
        ...
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="text-gray-400">
              ...
              <Link to="/signup" className="text-indigo-400 hover:text-indigo-300 ml-1 font-medium">
                Sign up
              </Link>
            </p>
          </div>
