  ...
  return (
    <div className="flex flex-col justify-center items-center gap-8 my-10 px-4 md:px-8 max-w-7xl mx-auto">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="flex items-center gap-3 mb-4 md:mb-0">
            ...
            />
            <span style={{ color: theme.text }} className="font-medium">Calvin Carlo</span>
          </div>
          
          <div className="flex items-center">
            <span className="text-2xl font-bold mr-4" style={{ color: theme.primary }}>$29</span>
            <motion.button 
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-6 w-full">
        ...
        >
          <div className="p-2 rounded-full" style={{ backgroundColor: `${theme.primary}20` }}>
            <TbClockHour2 size={20} style={{ color: theme.primary }} />
          </div>
          <div>
            <p className="text-xs" style={{ color: theme.secondary }}>Duration</p>
            <p className="font-medium" style={{ color: theme.text }}>10 hours</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div>
            <p className="text-xs" style={{ color: theme.secondary }}>Level</p>
            <p className="font-medium" style={{ color: theme.text }}>All Levels</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div>
            <p className="text-xs" style={{ color: theme.secondary }}>Lessons</p>
            <p className="font-medium" style={{ color: theme.text }}>16 Lessons</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div>
            <p className="text-xs" style={{ color: theme.secondary }}>Quizzes</p>
            <p className="font-medium" style={{ color: theme.text }}>0 Quiz</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div>
            <p className="text-xs" style={{ color: theme.secondary }}>Students</p>
            <p className="font-medium" style={{ color: theme.text }}>5 Students</p>
          </div>
        </motion.div>
      </div>
