  ...
  const cardcont = [
    {
      ...
      desc: `${t("contact.cards.location.description")}`,
      link: "https://maps.google.com",
    },
    {
      icon: FiPhone,
      title: `${t("contact.cards.phone.title")}`,
      desc: `${t("contact.cards.phone.description")}`,
      link: "tel:+1234567890",
    },
    {
      icon: MdOutlineEmail,
      title: `${t("contact.cards.email.title")}`,
      desc: `${t("contact.cards.email.description")}`,
    ...
    >
      <div className="max-w-5xl mx-auto mb-16 text-center">
        ...
        >
          ...
          ></div>
          <p className="max-w-2xl mx-auto" style={{ color: `${theme.text}99` }}>
