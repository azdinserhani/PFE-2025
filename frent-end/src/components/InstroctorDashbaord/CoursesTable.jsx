        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              style={{ 
                backgroundColor: showFilters ? `${theme.primary}20` : 'transparent',
                color: theme.text
              }}
        ...
        >
          <div className="flex flex-wrap gap-4">
            <div className="flex flex-col gap-1">
              <label style={{ color: theme.text, fontSize: '0.875rem' }}>Status</label>
              <select 
            ...
            <div className="flex flex-col gap-1">
              <label style={{ color: theme.text, fontSize: '0.875rem' }}>Price Range</label>
              <select 
                className="py-2 px-3 rounded-md border focus:outline-none"
                style={{ 
                  borderColor: `${theme.border}80`,
          ...
          components={{
            NoRowsOverlay: () => (
              ...
              >
                ...
                <p className="text-sm">Try changing your search criteria or add a new course</p>
              </div>
            ),
          }}
        />
