  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <FaDisplay fontSize={20} lg:fontSize={25} style={{ color: theme.primary }} />
          <div>
            <p className="text-sm lg:text-base" style={{ color: theme.secondary }}>Online Course</p>
            <span className="font-semibold text-xl lg:text-2xl" style={{ color: theme.text }}>100+</span>
          </div>
        </motion.div>
        <motion.div
          ...
          style={{ backgroundColor: theme.cardBg }}
        >
          <p className="text-sm lg:text-base" style={{ color: theme.secondary }}>Our instructor</p>
          <div className="flex">
            <div className="h-5 w-5 lg:h-7 lg:w-7 rounded-full -ml-2 lg:-ml-3 border border-white outline-1 cursor-pointer hover:z-10 duration-300" style={{ backgroundColor: theme.primary }}></div>
            <div className="h-5 w-5 lg:h-7 lg:w-7 rounded-full -ml-2 lg:-ml-3 border border-white outline-1 cursor-pointer hover:z-10 duration-300" style={{ backgroundColor: theme.primary }}></div>
            <div className="h-5 w-5 lg:h-7 lg:w-7 rounded-full -ml-2 lg:-ml-3 border border-white outline-1 cursor-pointer hover:z-10 duration-300" style={{ backgroundColor: theme.primary }}></div>
            <div className="h-5 w-5 lg:h-7 lg:w-7 rounded-full -ml-2 lg:-ml-3 border border-white outline-1 cursor-pointer hover:z-10 duration-300" style={{ backgroundColor: theme.primary }}></div>
          </div>
